...
# with open("upay_public_key.pem","wb") as f:
#     f.write(public_key.save_pkcs1("PEM"))

# with open("upay_private_key.pem","wb") as f:
...
message = "21upay2pbl12345678"

# The signature to verify (base64 decoded)
datasign = base64.b64decode('VCI8VyRWs2tv0seMa5BR0HbmzgNDjm6r5mACzufS19NvfYM7SkI3coEiKeX9+mVEc8qqmjVuQFiwpRWE8l3njEP3DSWTOtGyvusrGa6J6p6vP1JPg5qUCTnCG6fnjRTqQNnS9JkRPhqa43vpS61+hMCh8mzJ2GBhY3KxTgEg23M=')
...
# Verify the signature
try:
    print(rsa.verify(message.encode('utf-8'), datasign, public_key))
    print("The datasign is correct.")
except rsa.VerificationError:
    print("The datasign is incorrect.")
